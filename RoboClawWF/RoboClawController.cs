...
namespace RoboClawWF
{
    public class RoboClawController
    {
        ...
        public SerialTransport Setup()
        {
            ...
            {
                CurrentSerialSettings = { PortName = "COM11", BaudRate = 115200, Timeout = -1 } // object initializer
            };
        ...
        private void AttachCommandCallBacks()
        {
            ...
            _cmdMessenger.Attach((int)RoboClawCommand.kGetCurrentMotorStatus, OnGetCurrentMotorStatus);
            _cmdMessenger.Attach((int)RoboClawCommand.kAcknowledge, OnAcknowledge);
            _cmdMessenger.Attach((int)RoboClawCommand.kError, OnError);
            _cmdMessenger.Attach((int)RoboClawCommand.kGetDebugStr, OnGetDebugStr);
            _cmdMessenger.Attach((int)RoboClawCommand.kHMoveDoneMssg, OnHMoveDoneMssg);
            _cmdMessenger.Attach((int)RoboClawCommand.kGetFwVerStr, OnGetFwVerStr);
        ...
        /*
                public class RoboClawControllerOld
                {
                    public bool RunLoop { get; set; }
